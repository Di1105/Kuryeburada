...
class MyOrderToMeCell: UICollectionViewCell {
    
    static let identifier = "ToMeCell"
    ...
    override func layoutSubviews() {
        ...
        transitInfoLbl.font = Font.custom(size: 14, fontWeight: .medium)
